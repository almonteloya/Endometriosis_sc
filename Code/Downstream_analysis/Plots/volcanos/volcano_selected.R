## Volcano plots with highlighting genes from GSEA
...
####------ VSM
DEG_VSM<-readRDS("vascular-smooth-muscle_secretory_DEG.RDS")
...
## Printing volcano
DEG_WFC2<-readRDS("WFDC2+-fibroblast_secretory_DEG.RDS")
...
### ----- Proliferative
gsea = readRDS("/GSEA/HSP-stromal-fibroblast_proliferative_DEG.RDS_GSEA.RDS")
dir_out="/Fig3/"
##-- Reading the GSEA
#### HSP
DEG_HSP<-readRDS("HSP-stromal-fibroblast_proliferative_DEG.RDS")
...
##---- Secretory
dir_GSEA = "/epithelial_specific/GSEA/"
dir_out="Fig4/"
##-- Reading the GSEA
pat<-"*RDS$"
files_GSEA<- list.files( path= dir_GSEA, pattern = pat, full.names = TRUE)
...
####------ EMT
DEG_EMT<-readRDS("EMT-epithelia-1_secretory_DEG.RDS")
...
####------ Ciliated
DEG_Cil<-readRDS("/Ciliated-epithelia_secretory_DEG.RDS")
gsea<-filtered_markers[[1]]
...
####------ G1
DEG_G1<-readRDS("Glandular-1_proliferative_DEG.RDS")
