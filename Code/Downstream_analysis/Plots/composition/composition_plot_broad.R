...
plot_comp<-function(){
  ...
  make_meta_barplot(s_obj, Patient_id, labels_singleR_reduced, dittoColors())+
  ...
  make_meta_barplot(s_obj, Condition, labels_singleR_reduced, dittoColors())+
  ...
  make_meta_barplot(s_obj, condition_full, labels_singleR_reduced, dittoColors())+
    scale_fill_manual(values=dittoColors()[c(3,11,7,4)])+
    ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                        axis.text=element_text(size=15),)
  dev.off()
  
  pdf(paste0(dir_out,"bar_Condition_control.pdf"),height =8, width = 8)
  make_meta_barplot(s_obj, condition_control, labels_singleR_reduced, dittoColors())+
    scale_fill_manual(values=dittoColors()[c(3,7,4)])+
    ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                        axis.text=element_text(size=15),)
  dev.off()
  
  pdf(paste0(dir_out,"bar_Phase.pdf"),height =8, width = 8)
  make_meta_barplot(s_obj, Phase_menstrual_reduced, labels_singleR_reduced, dittoColors())+
  ...
  make_meta_barplot(s_obj, LIBRARY, labels_singleR_reduced, dittoColors())+
    scale_fill_manual(values=dittoColors())+
    ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                        axis.text=element_text(size=15),)
  dev.off()
...
make_meta_barplot(subset_cell, condition_full, labels_singleR_reduced, dittoColors())+
  scale_fill_manual(values=dittoColors()[c(3,11,7,4)])+
  ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                      axis.text=element_text(size=15),)
dev.off()
...
make_meta_barplot(subset_cell, condition_control, labels_singleR_reduced, dittoColors())+
  scale_fill_manual(values=dittoColors()[c(3,7,4)])+
  ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                      axis.text=element_text(size=15),)
dev.off()
...
make_meta_barplot(subset_cell, Phase_menstrual_reduced, labels_singleR_reduced, dittoColors())+
  scale_fill_manual(values=dittoColors()[c(2,1)])+
  ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                      axis.text=element_text(size=15),)
dev.off()
...
make_meta_barplot(subset_cell, LIBRARY, labels_singleR_reduced, dittoColors())+
  scale_fill_manual(values=dittoColors())+
  ylab("fraction of cluster") + theme(legend.text = element_text(size=15),
                                      axis.text=element_text(size=15),)
dev.off()
